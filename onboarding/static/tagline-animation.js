...
const alternatingText = document.getElementById("key-word");
const textOptions = ["movies","shows","music","media"];

const words = ["Media", "movies", "shows", "music"],
colors = ["blue", "green", "yellow", "red"],
text = document.getElementById("key-word");
